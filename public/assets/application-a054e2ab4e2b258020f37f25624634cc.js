...
$(function (){
        $('.reservation_assets').accordion({collapsible: true, active: false
    });
});

$(function (){
        $('#ip_list').accordion({collapsible: true, active: false
    });
});
(function() {
...
$(function (){
        $('#reservation_start_time').timepicker({'scrollDefault': 'now', 'timeFormat': 'H:i'});
        $('#reservation_end_time').timepicker({'scrollDefault': 'now', 'timeFormat': 'H:i'});
});
